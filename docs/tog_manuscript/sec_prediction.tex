...
%   gxd_sweep, presence_gate_v33 (same keys as sec_definition.tex), leak_ablation_ci.  shap_forensics was filled on
...
%   run_deep_tabular_baselines and run_scale_decomposition).  The earlier shap_leak_forensics_v33_m20000.json (05:29) has the
%   same test AUCs and leak shares but is not the cited file.  Keys: sample.n_matches_sampled 20000; split test rows 15911,
