...
|---|---|---|
| Dimitriadis–Gneiting–Jordan (2021) CORP + Gneiting–Raftery (2007) | **RR6a** | `forecast_diagnostics.py` CORP; `rr20260920_review_response_rr6a_corp.py` for **V→W** and **q→SVI** separately (diagnostic only; no TEST recalibration of frozen models) |
