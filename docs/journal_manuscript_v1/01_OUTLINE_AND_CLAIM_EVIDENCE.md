...
## Research questions (frozen — not redesigned)
...
|---|---|---|---|---|---|---|---|
| C1 | Frozen fit85 MLP \(\widehat V\) ranks match outcomes on 15.16 timeline | timeline overall n=347234 | Brier 0.1552; AUC 0.8542 | CORP MCB/DSC in RR6a | RR6a | supported | Measurement quality ≠ SVI validity alone |
...
| C7 | Among decided elite objectives in 180s, SVI+ vs SVI− Blue rates differ | decided | 0.604 vs 0.396 | — | RR5b | correspondence | Incomplete windows mostly game_ended_in_window (8112), not censored |
...
| C9 | On 15.16 all-T, frozen \(q\) beats tested PT_flex on Brier | n=32981; matches=24020 | ΔBrier −0.00373; q AUC 0.6403; PT_flex AUC 0.6200 | CI95 [−0.00461, −0.00279] | RR12 | **exploratory** (prior TEST exposure) | Beyond *tested* \(p,t\) summaries |
...
| C13 | On 15.16, q’s Brier gain vs PT_flex co-moves with higher DSC and somewhat higher MCB | all-T | ΔMCB +0.00033; ΔDSC +0.00406 | CORP score-gap | RR6a | supported as **decomposition** | Not a causal “mechanism” of the game |
...
| C15 | Main KR/NA1 16.13: q Brier **worse** than PT_flex | n=5202 / 5312 | ΔBrier +0.0026 / +0.0040 | CORP ΔMCB > ΔDSC | RRX | supported | Lift does not transfer under score-only freeze |
