...
**현재 수치는 v3.3이다. 아래 표의 v3 행은 `time_norm` 누수가 있는 특징으로 학습한 것이며 철회됐다**
(22절, `docs/RELEASE_REPORT_V3.md` 5.3). 규모 기울기는 누수가 만든 것이고 v3.3에서 사라진다.

| 프로토콜 / 라벨 | n | 전체 AUC | pick | skirmish | teamfight | pick − tf |
|---|---|---|---|---|---|---|
| **v3.3 ToG, market_event (주 라벨)** | **532,547** | **0.670** | **0.679** | **0.663** | **0.681** | **−0.002 [−0.007, +0.003]** |
| v3.3 ToG, market_lex | 538,593 | 0.694 | 0.701 | 0.685 | 0.712 | −0.011 |
| v3.3 ToG, Eq.3 | 561,721 | 0.624 | 0.666 | 0.621 | 0.599 | +0.067 |
| CoG, Eq.3 (시험) | 574,312 | 0.659 [0.656, 0.662] | early 0.611 | mid 0.696 | late 0.795 | — |
| ~~v3 ToG, market_lex (누수)~~ | 541,767 | 0.736 | 0.709 | 0.719 | 0.805 | −0.096 |
| ~~v3 ToG, market_event (누수)~~ | 535,444 | 0.702 | 0.673 | 0.686 | 0.770 | −0.098 |
| ~~v3 ToG, Eq.3 (누수)~~ | 540,774 | 0.682 | 0.657 | 0.666 | 0.744 | −0.088 |
...
컷오프 시점 존재 기준 teamfight(2.1%)는 0.837 — **이 값도 누수판(v3)에서 나온 것이라 인용하지 않는다.**
