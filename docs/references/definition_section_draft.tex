...
is therefore the constant that decides how many engagements a match contains, and any
claim about predicting them has to be shown at both ends of the bracket.
% TODO: report the model at (1,600 u, 15 s) alongside the reference point.
