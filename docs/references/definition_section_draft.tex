...
intervals and the ARI plateau; predictive validity -- the engagement outcome is predictable
from pre-cutoff state at AUC 0.70--0.74 depending on the outcome currency, with the
same scale gradient under every currency (Section~\ref{sec:results}). Construct validity is a
