...
from cache_io import build_match_pairs, prebuild_cache
...
def run(args) -> None:
    ...
    for R in r_sweep:
        ...
        check_split_leakage(tr_refs, va_refs, te_refs, run_log)
            ...
            if not base_logit_map_full:
                ...
                if enable_factorial:
                    ...
                    if len(cand_names) >= 2:
                        ...
                        meta_method = str(getattr(args, "oof_meta", "logreg"))
                ...
                if len(base_names) < 2:
                    ...
                    if stacking_mode == "oof":
                        ...
                        out_dir = ensure_dir(fusion_root / "simple_val_fit")
                        stack_simple(
                            tr_refs=tr_refs,
                            va_refs=va_refs,
                            te_refs=te_refs,
